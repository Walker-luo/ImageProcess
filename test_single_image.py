...
def parse_args():
    ...
    parser.add_argument('--model_path', help='Path of model snapshot.', type=str,default='./model_parameters/Model_SwinT_AVA_epoch_10.pth')
    parser.add_argument('--popt_file', type=str, default='./model_parameters/Model_SwinT_AVA_epoch_10.pth')
